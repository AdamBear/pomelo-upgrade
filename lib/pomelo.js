...
defineGetter(pomelo.monitors, 'zookeepermonitor', load.bind(null, './monitors/zookeeperMonitor'));
defineGetter(pomelo.monitors, 'redismonitor', load.bind(null, './monitors/redisMonitor'));
